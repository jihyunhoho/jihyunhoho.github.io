		...
		return this
				.each(function() {
					...
					var sortkeys = [ "shiftKey", "altKey", "ctrlKey" ], intNum = function(val, defval) {
						...
						// [2014.6.11] 해당 그리드에서 마우스 오버 시 보여지는 title을 해당 데이터 외 다른 데이터로 보여지고 싶을 때..
						if (cm.alttype != undefined) {
							result += gridAltManipulation(clas, cm.title, tv, rawObject, cm.alttype);
						} else {
